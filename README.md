...
# How do I use it?
After downloading [Karabiner Elements](https://karabiner-elements.pqrs.org/) and giving it the required permissions, just paste the json into "Add your own rule" (submission to auto download is pending)
<!-- this link into your browser. `karabiner://karabiner/assets/complex_modifications/import?url=https://raw.githubusercontent.com/ProfXwing/extend-karabiner/master/extend.json` -->

# What are the changes?
The following is an image of DreymaR's extend layer for reference.
![text based example](image.png)
![icon based example](image-1.png)
